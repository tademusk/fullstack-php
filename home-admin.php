    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark sticky-top border-bottom">
        <div class="container">
            <a href="#" class="navbar-brand"><img src="haremaya-log.png" alt="LOGO" id="theImage" width="30" height="30" class="bi" fill="currentColor" viewBox="0 0 16 16">
                ...
                <div class="text-light nav-item mx-3 px-3">
                <h4 class="m-2"><?php echo "welcome to"."<span class='text-danger bg-light rounded pb-1 px-2 mx-2'> Administrator's </span>". " "."page"; ?></h4>
                  </div>
            ...
            <div class="collapse navbar-collapse" id="navmenu">
                ...
                <li class="nav-item">
                        ...
                        data-bs-target="#remove-user-model">Remove user</button>
                    </li>
                    <li class="nav-item">
                        <button type="button" class="btn btn-success btn-md m-2" data-bs-toggle="modal" data-bs-target="#get-book-model">Get-book</button>
                    </li>
                    <li class="nav-item">
                        <button type="button" class="text-light btn btn-warning btn-md m-2" data-bs-toggle="modal" data-bs-target="#add-book-model">Add-book</button>
                    </li>
                    <li class="nav-item">
...
<div class="modal fade" id="add-book-model" aria-hidden="true" aria-labelledby="register-modalLabel" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
         <div class="modal-header">
             <h5>Fill <span class="text-primary">book</span> info.</h5>
             <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="model-body container">
            <form p-5>
...
<div class="modal fade" id="remove-user-model" aria-hidden="true" aria-labelledby="register-modalLabel" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
         <div class="modal-header">
             <h5>Enter <span class="text-primary">User's </span>Information.</h5>
             <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          </div>
          <div class="model-body container">
            <form p-5>
              <div class="mb-2">
                <label for="id-number" class="col-form-label">Enter user Id:</label>
                <input type="text" class="form-control" id="user-id">
              </div>
              <div class="mb-2">
                <label for="password" class="col-form-label">Enter user's Email:</label>
