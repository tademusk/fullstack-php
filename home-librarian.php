    ...
    <nav class="navbar navbar-expand-md bg-dark navbar-dark sticky-top border-bottom">
        <div class="container">
            <a href="#" class="navbar-brand"><img src="haremaya-log.png" alt="LOGO" id="theImage" width="30" height="30" class="bi" fill="currentColor" viewBox="0 0 16 16">
                ...
                <h4 class="m-2"><?php echo "welcome to" . "<span class='text-danger bg-light rounded pb-1 px-2 mx-2 text-center'> Librarians'  </span>". "page"; ?></h4>
                  </div>
            ...
            <div class="collapse navbar-collapse" id="navmenu">
                <ul class="navbar-nav ms-auto navbar-nav-scroll">
                    <li class="nav-item">
                        <button type="button" class="btn btn-info btn-md m-2" data-bs-toggle="modal" data-bs-target="#get-book-model">Get-book</button>
                    </li>
                    <li class="nav-item">
                        <button type="button" class="text-light btn btn-primary btn-md m-2" data-bs-toggle="modal" data-bs-target="#add-book-model">Add-book</button>
                    </li>
                    <li class="nav-item">
