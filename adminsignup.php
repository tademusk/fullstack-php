<?php
  ...
  $user_check_query = "select * from admin where id='$IdNumber' or email='$email' limit 1";
  ...
  {
    $query="insert into admin(id,fullname,email,password) value('$IdNumber','$full_name','$email','$password')";
    mysqli_query($conn,$query);
    $congra = "you are successfully registered! please   ". "<a href='adminlogin.php'>LOG IN<a>";
  }
?>
...
<div class="signup-form">
	...
	<div class="text-light bg-success mb-5 p-5 ">
		...
		<h2>Register</h2>
		<p class="hint-text">Create your account As an <span class="text-primary"> ADMINISTRATOR </span> here.</p>
        <div class="form-group">
			<div class="row">
				<div class="col-xs-6"><input type="text" class="form-control" name="full_name" placeholder="Full name" required></div>
				<div class="col-xs-6"><input type="text" class="form-control" name="id_number" placeholder="Admin ID" required></div>
			</div>        	
        </div>
        <div class="form-group">
